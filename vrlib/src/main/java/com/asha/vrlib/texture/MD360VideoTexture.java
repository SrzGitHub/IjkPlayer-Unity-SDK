...
public class MD360VideoTexture extends MD360Texture {
    ...
    public boolean texture(MD360Program program) {
        ...
        GLES30.glUniform1iv(program.getUseTextureTransformHandle(), 1, sUseTransform, 0);
        GLES30.glUniformMatrix4fv(program.getSTMatrixHandle(), 1, false, mTransformMatrix, 0);
        return true;
    }
